...
public class Md4 {
    ...
    public static String getMd4ofStr(String s) {
        return toHexString(mdfour(s.getBytes(StandardCharsets.UTF_8)));
    }

    public static String getMd4ofStr(byte[] bytes) {
        return toHexString(mdfour(bytes));
    }

    public static byte[] getMd4ofBytes(String s) {
        return mdfour(s.getBytes());
    }

    public static byte[] getMd4ofBytes(byte[] bytes) {
        return mdfour(bytes);
    }
}
